...
import { getUserController, loginController, logoutController, registerController, requestFriendController, searchFriendsController, getFriendsController, acceptFriendController, rejectFriendController, deleteFriendController, getPendingRequestsController } from './user.controller';
...
userRouter.get('/pendingRequests',requireUser,catchAsync(getPendingRequestsController));
...
userRouter.post('/deleteFriend/:friendId',requireUser,processRequestParams(friendIdSchema),catchAsync(deleteFriendController));
